...
<%--<%@include file="../2cjsp/admin/admin_header.jsp  " %>--%>
<%--<%@include file="../2cjsp/admin/adminNavigator.jsp" %>--%>
<html>
<head>
    <title>库存展示</title>
...
<div class="container" style="float: left ; margin-left: 10px; width: 1630px;">
    <div class="row clearfix">
        <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15 column">
            <div class="page-header" style="font-size: 10px; " >
                <h4>库存情况</h4>
            </div>
        </div>
    </div>
